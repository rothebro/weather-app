...
def home():
    ...
    <form method="POST">
        <input type="text" name="city" placeholder="Enter a city" style="width: 150px; margin-right: 5px;" required>
        <input type="number" name="days" placeholder="1–10 days" min="1" max="10" style="width: 120px; margin-right: 5px;" required>
